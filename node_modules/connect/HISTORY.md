...
==================
  ...
  * Fixed `static()` _/_ support on windows
...
==================
  ...
  * Fixed content-type in `static()` for _/_
...
==================
  ...
  * Revamped the api, view the [Connect documentation](http://extjs.github.com/Connect//#Middleware-Authoring) for more info (hover on the right for menu)
